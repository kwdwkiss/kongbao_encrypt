...
class SoapDiscovery {
	...
	public function __construct($class_name = '', $service_name = '',$path="") {
		...
		$this->path = $path;
		$this->filename  = $this->path.$this->class_name;
	}
	...
	public function getWSDL($url) {
		...
		$serviceWSDL = '<service name="'.$this->service_name."\">\n<documentation />\n<port name=\"".$this->service_name.'Port" binding="tns:'.$this->service_name."Binding\"><soap:address location=\"".$url."\" />\n</port>\n</service>\n";
		$messageWSDL = '';
		...
		$bindingWSDL.= "</binding>\n";
		$fso = fopen($this->filename . ".wsdl" , "w"); 
